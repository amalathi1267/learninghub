...
export default function MobileTestingCourse() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Mobile Testing Course</h1>
          
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Course Overview</h2>
            <p className="text-gray-700 mb-6">
              Master mobile application testing with our comprehensive course. Learn to test
              Android and iOS applications using industry-standard tools and methodologies.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li>Mobile Testing Fundamentals</li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  ...
                  <li>Projects: 4+ Testing Projects</li>
