        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="h-10 w-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-sky-500 transition-colors duration-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/courses" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
                  All Courses
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-gray-400 hover:text-sky-400 transition-colors duration-300">
                  Blog
                </Link>
              </li>
            </ul>
